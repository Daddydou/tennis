...
/**
 * Données du référentiel des tournois : une fiche par slug (surface,
 * catégorie, semaine ISO), pour chaque circuit, et les alias WTA. La logique
 * de recherche vit dans lib/calendrier.ts.
 */
 ...
 */
export const CALENDRIER: Record<string, Fiche> = {
 ...
 *      pas.
 */
export const CALENDRIER_WTA: Record<string, Fiche> = {
  // — Janvier : tournée australienne
 ...
 */
export const ALIAS_WTA: Record<string, string> = {
