/**
 * PARSER — lecture du JSON brut du bookmarklet (tours, circuit, identité du
 * tournoi, matchs). Cf. l'en-tête de lib/parser.ts, point d'entrée qui
 * réexporte ce fichier.
 */

import type { DrawExtract, Half, Match, MatchStatus, Tour } from './types';
